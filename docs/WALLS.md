...
沒有探索地板觸發的透明剖面。探索霧亮度沿用；3.22.2 改為地板／痕跡／物件／人物／效果先畫，牆最後畫，遮住它們與牆重疊的部分。整塊牆先有不透明底，霧亮度只調材質，不讓戰場內容透出。HTML HUD／資訊卡仍獨立在介面層。高牆只改畫面投影，四方向點選、移動、掩體、視線與射線仍使用原地板座標。
...
五項牆測試已更新，涵蓋 16 種鄰接、縮放接縫、64 搭配、實心頂板、缺圖回退、牆遮擋痕跡／人物／效果的繪製順序、四方向點選、存檔／RNG 不變與 PNG 色盤／SHA。本批全套 273 項測試與 build 通過。未自行跑瀏覽器或手機 QA。
