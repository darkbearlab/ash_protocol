...
import {Game,WEAPONS,FLOORS,floorInfo,PERKS,ENEMY_TYPES,LORE,enemyName,distance,protocolSettlement} from './engine.js';
...
document.addEventListener('click',e=>{
  ...
  if(b.dataset.modal){switch(b.dataset.modal){
    ...
    case 'deployBackOperator':deployDraft={...deployDraft,difficulty:$('input[name="difficulty"]:checked')?.value,realMode:Boolean($('input[name="real-mode"]')?.checked)};showDeployOperator();break;
    case 'new':{const {character,color}=deployDraft,options=runOptions({difficulty:$('input[name="difficulty"]:checked')?.value,realMode:Boolean($('input[name="real-mode"]')?.checked)});
