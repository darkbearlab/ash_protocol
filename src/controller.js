...
function showCarrying(){const p=profile();modal(`<h2>協定點數 ${p.protocol.balance}</h2><p>已解鎖職業 ${availableCharacters(p).length} · 故事 ${p.unlocks.stories.length}</p><button class="modal-button" data-modal="close">返回</button>`);}
