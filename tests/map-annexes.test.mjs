...
class Game extends CurrentGame{generateFloor(){return generate(this.seed,this.floor);}static restore(raw){const g=super.restore(raw);if(g)Object.setPrototypeOf(g,this.prototype);return g;}}
