...
export const CHARACTERS={
  ...
  necromancer:{...defaults,name:'Necromancer',label:'死靈法師',text:'本層倒下過的敵人會每 4 回合自動起身為召喚物，最多三隻；技能免費集結，把牠們叫回身邊。',traits:['biological'],weapons:[2,1],skills:['raise_dead'],prepared:{skill:'raise_dead'}},
