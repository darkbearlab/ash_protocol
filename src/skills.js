...
export const SKILLS={
 drone_follow:{name:'追隨僚機',short:'僚機',icon:'◇',action:'skill',cost:1,duration:0,cooldown:0,text:'一台機體，部署／靠近回收各 1 回合；回收補手槍彈，45 HP／12 發／射程 5。繩索 6 格，不主動追擊，損毀無法重造。'},
 drone_sentry:{name:'放置哨兵',short:'哨兵',icon:'▣',action:'skill',cost:1,duration:0,cooldown:0,text:'與追隨僚機共用機體。45 HP／8 發步槍彈／射程 7，不移動；超出 6 格停止運作。3 格可通路內可回收或隨行。'},
