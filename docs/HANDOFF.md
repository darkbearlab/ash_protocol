...
- 單局 `ash-save`：save **v70**（`data.js` 的 `SAVE_VERSION`；3.159.0 升 69、3.164.0 升 70）。舊版 1～69 都能讀（`LEGACY_SAVE_VERSIONS` 自動推算），讀取前先存 `ash-save-v{N}-backup`。
