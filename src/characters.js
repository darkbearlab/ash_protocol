...
export const CHARACTERS={
  ...
  berserker:{...defaults,name:'Berserker',label:'狂戰士',text:'血厚的近戰職業。鉤鎖把敵人拉到身邊，大型與頭目則衝過去，到位後補一刀；近戰吸血，連續斬殺疊減傷，攜帶的近戰武器越多越強。射擊較不準。天生壓制抗性一階、抗毒一階。',hp:160,armor:3,combat:{rangedAccuracy:-10},traits:['suppression_resistance','biological','poison_resistance','bloodlust','battle_spirit','blade_stash'],weapons:[9,1],skills:['grapple'],prepared:{skill:'grapple'}},
