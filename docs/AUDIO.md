...
輕機槍、榴彈發射器與雷鳴爆彈槍發射、所有近戰（玩家與敵人）、毒液、友軍寵物砲台、投擲物出手與煙霧／EMP／震撼、撿取與開箱、終端、電梯與換層、修復噴劑、腎上腺素、佩戴件、設置掩體、門與隔板被破壞、技能、蟲巢與舌頭、頭目、玩家陣亡、撤離與結算、選單返回；玩家受傷目前和命中共用同一聲。製作規格另開給 Codex。
