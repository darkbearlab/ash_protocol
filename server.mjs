...
http.createServer(async (req,res) => {
  try {
    ...
    const publicFile = pathname === '/' || ['/index.html','/style.css','/expansion.css','/manifest.webmanifest','/sw.js'].includes(pathname) || /^\/(src\/[a-z0-9-]+\.js|assets\/(pixel\/)?[a-z0-9-]+\.(svg|png|json))$/.test(pathname);
