...
export const CHARACTERS={
  ...
  ninja:{...defaults,name:'Ninja',label:'忍者',text:'偵察兵的近戰變體。光學迷彩讓敵人難以命中；目標失能、看不到他或他身在暗處時伏擊加傷，只剩一名敵人看得到他時更難被打中。開局帶煙霧與震撼彈。',combat:{rangedEvasion:10},traits:['biological','sidestep','night_vision','ambush','duelist'],weapons:[10,2],skills:['camouflage'],prepared:{grenade:'smoke',skill:'camouflage'},supplies:{grenades:0,smoke:2,stun:1}},
};
