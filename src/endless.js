...
export const ENDLESS_TUNING={hpGrowth:.07,damageGrowth:.04,densityEvery:6,densityMax:3,get heavyExtra(){return expandRoster(factionDef(DEFAULT_FACTION).roster.deepExtra);}};
