...
export const CHARACTERS={
  ...
  ninja:{...defaults,name:'Ninja',label:'忍者',text:'偵察兵的近戰變體。光學迷彩讓敵人難以命中；目標失能、任一方在煙霧中、目標還沒發現他或他身在暗處時伏擊加傷，只剩一名敵人看得到他時更難被打中。副武器是衝鋒槍，3 格內射擊忽略掩體與目標移動、命中 +10；投擲容量 +2，開局四顆煙霧彈與一顆震撼彈。',combat:{rangedEvasion:10},carryBonus:{grenade:2},traits:['biological','sidestep','night_vision','ambush','duelist','point_blank'],weapons:[10,2],skills:['camouflage'],prepared:{grenade:'smoke',skill:'camouflage'},supplies:{grenades:0,smoke:4,stun:1}},
};
