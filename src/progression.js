// Stable IDs for future weapon-pool / character unlocks. No store or spending yet.
...
export function normalizeProfile(raw={}) {
  ...
  return {...p,version:2,runs:integer(p.runs),wins:integer(p.wins),bestFloor:Math.max(1,integer(p.bestFloor)),bestKills:integer(p.bestKills),
