...
// Ranks that come off each tick: the sealed suit's (hazmat, five a rank) plus the native rank (3.160.0).
export const poisonResistance=p=>Math.floor((p.hazmat||0)/T.hazmatPerPoisonPoint)+(activeTrait(p,'poison_resistance')?1:0);
