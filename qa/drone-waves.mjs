// 3.91.0 起過時：這個場景靠「回收再部署補彈」，工坊已取消回收，開局備彈也改成手槍彈，數字不再有意義。
// 保留作歷史紀錄；現在執行會直接結束。之後需要時改寫成工坊版本（docs/ENGINEER.md）。
console.log('drone-waves: obsolete since 3.91.0 (engineer workshop).');process.exit(0);
