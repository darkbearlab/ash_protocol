...
import {Game,WEAPONS,FLOORS,floorInfo,PERKS,ENEMY_TYPES,enemyName,distance,protocolSettlement,itemUseReason,TERMINAL_ITEMS,TERMINAL_STOCK,terminalReason} from './engine.js';
...
function useItem(){const entry=preparedEntry(game.player,'item');
