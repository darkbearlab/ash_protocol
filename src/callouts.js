...
export function receiveCallout(g,actor,kind,detail={}){
 ...
 // 3.127.1: conscripts and the enforcer speak for themselves, seen or heard, like civilians.
 const own=actor.conscript?'conscript':enemyDef(actor)?.speaksAs??(isNoncombatant(actor)?enemyDef(actor).voice:null);
