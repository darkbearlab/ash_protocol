...
export const actorStat=(actor,key)=>(validCharacter(actor?.character)?CHARACTERS[actor.character].combat?.[key]||0:0)+(actor?.combatModifiers?.[key]||0)-(['rangedAccuracy','meleeAccuracy'].includes(key)?suppressionPenalty(actor):0);
